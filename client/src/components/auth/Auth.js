        ...
        <div className="w-full h-screen flex items-center">
            ...
            <div className="flex-3 bg-white h-full flex flex-col items-center justify-center">
                <div className="w-full">
                    <h1 style={{ fontSize: "45px" }} className="w-full text-center">
            ...
            <div className="flex-2 bg-teal-600 h-full flex items-center justify-center">
                <div className="w-96">
                    <form className="" onSubmit={handleSubmit}>
                        ...
                        {toggleLogin && (
                            <div className="flex flex-col mb-6">
                                ...
                                >
                                    ...
                                    <option value="Medical Laboratory Sciences">
                        ...
                        <button
                            type="submit"
                            className="bg-white py-2 px-3 rounded-full flex items-center justify-center gap-x-2 w-full text-teal-600 group mt-4 disabled:opacity-50"
